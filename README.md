...
<img alt="GitHub language count" src="https://img.shields.io/github/languages/count/isaiasnhantumbo/desafio-ignite-reactjs-criando-um-hook-de-carrinho-de-compras">
<img alt="GitHub language count" src="https://img.shields.io/github/languages/top/isaiasnhantumbo/desafio-ignite-reactjs-criando-um-hook-de-carrinho-de-compras">
<img alt="GitHub language count" src="https://img.shields.io/github/repo-size/isaiasnhantumbo/desafio-ignite-reactjs-criando-um-hook-de-carrinho-de-compras">
<img alt="GitHub language count" src="https://img.shields.io/github/license/isaiasnhantumbo/desafio-ignite-reactjs-criando-um-hook-de-carrinho-de-compras">
</h2>
<br>
<p align="center">
...
<p align="center">
O <span>Rocketshoes</span> é e-commerce para venda de sapatos,  que foi dado o template como desafio no Bootcamp Ignite da Rockeseat na trilha Reactjs para criar um hook de carrinho de compras.
<!-- <p align="center">
...
## ⛈  Desafios do projecto
  - [x] Mostrar em tela a quantidade de produtos distintos adicionados ao carrinho
  - [x] Deve adicionar um produto no carrinho
  - [x] Deve remover um produto no carrinho
...
$ git clone <https://github.com/isaiasnhantumbo/desafio-ignite-reactjs-criando-um-hook-de-carrinho-de-compras.git>
